...
import { ArrowLeft, Mail, Lock, MapPin } from 'lucide-react';
  ...
  return (
    <div ref={pageRef} className="min-h-screen flex flex-col items-center justify-center px-6 py-12 bg-[#f5f5f7] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] opacity-40 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at top, rgba(99,102,241,0.1) 0%, transparent 70%)' }} />
      ...
      <div className="w-full max-w-[440px] relative z-10">
        ...
        <div className="reveal reveal-delay-1 bg-white rounded-[24px] shadow-xl shadow-slate-200/50 border border-slate-100 p-8 sm:p-10">
          ...
          <div className="relative flex items-center mb-8">
            ...
            <span className="flex-shrink-0 px-4 text-xs font-semibold text-slate-400 uppercase tracking-widest">or sign in with email</span>
            <div className="flex-grow border-t border-slate-200"></div>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a href="#" className="text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">Forgot?</a>
              </div>
              <div className="relative">
        ...
        <p className="reveal reveal-delay-2 text-center text-slate-500 text-sm font-medium mt-8">
          ...
          <Link href="/register" className="text-indigo-600 hover:text-indigo-700 font-semibold transition-colors">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
